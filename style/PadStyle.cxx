...
namespace Bober {
  ...
  void PadStyle::ExportToXML(XMLNode* node) const {
    ...
    if (Find(kBottomMargin)) node->AddAttrib(new Bober::XMLAttrib("BottomMargin", Form("%4.4f", GetF(kBottomMargin))));
    if (Find(kLeftMargin)) node->AddAttrib(new Bober::XMLAttrib("LeftMargin", Form("%4.4f", GetF(kLeftMargin))));
    if (Find(kTopMargin)) node->AddAttrib(new Bober::XMLAttrib("TopMargin", Form("%4.4f", GetF(kTopMargin))));
    if (Find(kRightMargin)) node->AddAttrib(new Bober::XMLAttrib("RightMargin", Form("%4.4f", GetF(kRightMargin))));
    if (Find(kLogx)) node->AddAttrib(new Bober::XMLAttrib("Logx", Form("%i", GetI(kLogx))));
    if (Find(kLogy)) node->AddAttrib(new Bober::XMLAttrib("Logy", Form("%i", GetI(kLogy))));
    if (Find(kLogz)) node->AddAttrib(new Bober::XMLAttrib("Logz", Form("%i", GetI(kLogz))));
    if (Find(kGridx)) node->AddAttrib(new Bober::XMLAttrib("Gridx", Form("%i", GetI(kGridx))));
    if (Find(kGridy)) node->AddAttrib(new Bober::XMLAttrib("Gridy", Form("%i", GetI(kGridy))));
    if (Find(kGridz)) node->AddAttrib(new Bober::XMLAttrib("Gridz", Form("%i", GetI(kGridz))));
    if (Find(kTickX)) node->AddAttrib(new Bober::XMLAttrib("Tickx", Form("%i", GetI(kTickX))));
    if (Find(kTickY)) node->AddAttrib(new Bober::XMLAttrib("Ticky", Form("%i", GetI(kTickY))));
  }
